...
const useMarvelService = () => {
    ...
    const searchCharacter = async (name) => {
        ...
        return res.data.results[0] ? _transformCharacter(res.data.results[0]) : 'none';
    }
    ...
    return {loading, error, getAllCharacters, getCharacter, searchCharacter, getAllComics, getComic, clearError};
}
